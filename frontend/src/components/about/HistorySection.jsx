      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <SectionHeading
              badge="संस्थापक एवं इतिहास"
              title="गुरुकुल का गौरवशाली इतिहास"
              subtitle="स्वामी त्यागानन्द सरस्वती जी द्वारा स्थापित अयोध्या की पावन विद्यापीठ"
              align="left"
              className="mb-6"
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="p-4 rounded-xl bg-orange-50/80 border border-orange-200">
                <div className="flex items-center gap-2 text-gurukul-saffron font-bold text-sm mb-1">
                  ...
                  <span>स्थापना काल</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 font-semibold">{history.established}</p>
              </div>

              <div className="p-4 rounded-xl bg-amber-50/80 border border-amber-200">
                <div className="flex items-center gap-2 text-amber-800 font-bold text-sm mb-1">
                  <MapPin className="w-4 h-4" />
                  <span>संस्थापक जन्मस्थान</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 font-semibold">{history.founderBirthPlace}</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[340px] rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-400 bg-amber-50">
              <img
                src={founderImg}
                alt="स्वामी त्यागानन्द सरस्वती - संस्थापक एवं प्रथम कुलपति"
