...
import { ShieldAlert, Check, Gift } from 'lucide-react';

export const AdmissionRules = () => {
  const { rules, freeFacilities } = ADMISSION_DATA;
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-6 space-y-6">
            <SectionHeading
              badge="निःशुल्क सुविधाएँ"
              title="गुरुकुल द्वारा प्रदत्त निःशुल्क सुविधाएँ"
              subtitle="विद्यार्थी के सर्वांगीण विकास हेतु आवश्यक प्रत्येक सुविधा पूर्णतः निःशुल्क"
              align="left"
              className="mb-6"
            />
          ...
          <div className="lg:col-span-6 space-y-6">
            <SectionHeading
              badge="गुरुकुल मर्यादा"
              title="अनुशासन एवं आचार संहिता"
              subtitle="परिसर में प्रत्येक ब्रह्मचारी द्वारा पालन किए जाने वाले अनिवार्य नियम"
              align="left"
              className="mb-6"
            />
